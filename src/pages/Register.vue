<template>
  <div class="flex flex-col items-center space-y-4 mt-4">
    ...
    <input @keyup.enter="onRegister" v-model="password" type="password" class="w-96 px-4 py-3 rounded border border-gray-300 focus:ring-2 focus:border-primary focus:outline-none" placeholder="비밀번호">
    <button v-if="loading" class="w-96 rounded bg-light text-white py-4">회원가입 중입니다.</button>
